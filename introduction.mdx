...
description: 'Use Alloy’s integrations platform to rapidly launch new integrations'
---

<Frame>
  <iframe
    src="https://www.youtube.com/embed/r-jk_Fl-VmY"
...
<Card
  title="How to build your first integration"
  icon="network-wired"
  iconType="duotone"
></Card>
<Card
  title="How to embed the Alloy SDK in your codebase"
  icon="code"
  iconType="duotone"
></Card>
