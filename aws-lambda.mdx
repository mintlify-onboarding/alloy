...
3. Once on the user, go to the Permissions tab and choose "Add permissions" and search for AWS Lambda. Be sure to select "Attach policies directly" in the Permission options section.  
![](/images/9d8766a-Screenshot_2023-01-27_at_2.12.35_PM.png)  
![](/images/214a835-Screenshot_2023-01-27_at_2.13.56_PM.png)
...
_Tip: AWS Lambda is available in the following 19 regions:_ 
