...
In this article, you'll learn how to set up your DynamoDB account to work with the Alloy platform.
...
3. Once on the user, go to the Permissions tab and choose "Add permissions" and search for DynamoDB. Be sure to select "Attach policies directly" in the Permission options section.  
![](/images/9d8766a-Screenshot_2023-01-27_at_2.12.35_PM.png)  
![](/images/9877711-Screenshot_2023-01-27_at_2.10.58_PM_1.png)
...
_Tip: DynamoDB is available in the following 19 regions:_ 
